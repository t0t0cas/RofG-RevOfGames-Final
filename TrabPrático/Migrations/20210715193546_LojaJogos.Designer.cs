...
namespace TrabPrático.Migrations
{
    ...
    [Migration("20210715193546_LojaJogos")]
    partial class LojaJogos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "c",
                            ConcurrencyStamp = "55d23bc0-ad51-429e-b3f5-c08672b5d152",
                            Name = "Cliente",
                        ...
                        {
                            Id = "g",
                            ConcurrencyStamp = "189e0d70-5e6f-4e84-a29f-5629d1b45d74",
                            Name = "Gestor",
            ...
            modelBuilder.Entity("TrabPrático.Models.Jogos", b =>
                {
                    ...
                    b.Property<string>("LinkJogo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("LojaFK")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Descricao = "FIFA 21 é um videojogo de simulação de futebol desenvolvido e publicado pela Electronic Arts, tendo como estrela da capa o jogador Kylian Mbappé.O jogo foi anunciado a 19 de junho de 2020, sendo, no mesmo ano, oficialmente publicado no dia 9 de outubro. Lançado de acordo com a temporada 2020-2021, o jogo apresenta como grandes novidades as novas mecânicas de simulação no modo carreira, junto com um editor de estádios no modo Ultimate Team.FIFA 21 foi o primeiro título da série de videojogos FIFA, pertencente à EA Sports, a receber uma versão para as consolas da nova geração. Intitulado de Next Level Realism, o upgrade garantiu uma maior velocidade dos menus, menor tempo de loadings, novo relvado, novas faces, atualizações de estádios, atualização da neve, novos detalhes extracampo e melhorias nas texturas.",
                            Imagem = "FIFA21.jpg",
                        ...
                        new
                        {
                            ...
                            LinkJogo = "https://store.steampowered.com/app/292030/The_Witcher_3_Wild_Hunt/",
                            LojaFK = 1,
                            Media = 0.0,
                        ...
                        new
                        {
                            ...
                            LinkJogo = "https://store.steampowered.com/app/582160/Assassins_Creed_Origins/",
                            LojaFK = 1,
                            Media = 0.0,
                        ...
                        new
                        {
                            ...
                            Imagem = "GTAV.jpg",
                            LinkJogo = "https://store.steampowered.com/app/271590/Grand_Theft_Auto_V/",
                            LojaFK = 1,
                            Media = 0.0,
                        ...
                        new
                        {
                            ...
                            Imagem = "FootballManager_2021.jpg",
                            LinkJogo = "https://store.steampowered.com/app/1263850/Football_Manager_2021/",
                            LojaFK = 1,
                            Media = 0.0,
                        ...
                        new
                        {
                            ...
                            LinkJogo = "https://store.steampowered.com/app/374320/DARK_SOULS_III/",
                            LojaFK = 1,
                            Media = 0.0,
                            Nome = "Dark Souls III",
                            Nota = 89.0,
                        ...
                        new
                        {
                            ...
                            Imagem = "NeedForSpeedHeat.jpg",
                            LinkJogo = "https://store.steampowered.com/app/1222680/Need_for_Speed_Heat/",
                            LojaFK = 1,
                            Media = 0.0,
                        ...
                        new
                        {
                            ...
                            Imagem = "OriWillOfTheWisps.jpg",
                            LinkJogo = "https://store.steampowered.com/app/1057090/Ori_and_the_Will_of_the_Wisps/",
                            LojaFK = 1,
                            Media = 0.0,
                        ...
                        new
                        {
                            ...
                            Imagem = "Far_Cry5.jpg",
                            LinkJogo = "https://store.steampowered.com/app/552520/Far_Cry_5/",
                            LojaFK = 1,
                            Media = 0.0,
                            Nome = "FarCry 5",
                            Nota = 78.0,
            ...
            modelBuilder.Entity("TrabPrático.Models.Jogos", b =>
                {
                    b.HasOne("TrabPrático.Models.Loja", "Loja")
                        .WithMany("LojaJogos")
                        .HasForeignKey("LojaFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
